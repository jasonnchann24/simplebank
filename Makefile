...
mock:
	mockgen -package mockdb -destination ./db/mock/store.go github.com/jasonnchann24/simplebank/db/sqlc Store

.PHONY: postgres pg-up createdb dropdb migrateup migrateup1 migratedown migratedown1 sqlc test server mock 